      ...
      <div class="flex-item">
        <el-card shadow="nerver" class="demo-card fh">
          ...
          >
            ...
            <el-table-column prop="tableName" label="表英文全稱" show-overflow-tooltip></el-table-column>
            <el-table-column prop="comment" label="表描述、中文名稱" show-overflow-tooltip></el-table-column>
            <el-table-column prop="detailTableName" label="子表英文全稱" show-overflow-tooltip></el-table-column>
            <el-table-column prop="detailComment" label="子表描述、中文名稱" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="folder" label="代碼相對文件夾路徑" show-overflow-tooltip></el-table-column>
            <el-table-column prop="options" label="其它生成選項" show-overflow-tooltip></el-table-column>
            <el-table-column prop="typeName" label="分類名稱" show-overflow-tooltip></el-table-column>
          </el-table>
          <pagination
            v-show="firstTotal>0"
            :total="firstTotal"
            :page.sync="firstQuery.page"
            :limit.sync="firstQuery.limit"
      ...
      <el-row class="flex-item">
        <el-col :span="showTitleDialog ? 12 : 0" class="fh form-card">
          <el-card shadow="nerver" class="demo-card fh">
            <div slot="header">
              ...
              <span v-else>{{tableName}}頭信息</span>
            </div>
            <el-form
              :rules="mainRules"
              ref="dataForm"
            ...
            >
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item size="mini" :label="'表英文全稱'" prop="tableName">
                    <el-input v-model="firstTemp.tableName" :disabled="!editModel"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item size="mini" :label="'表描述、中文名稱'" prop="comment">
                ...
                <el-col :span="12">
                  <el-form-item size="mini" :label="'子表英文全稱'" prop="detailTableName">
                    <el-input v-model="firstTemp.detailTableName" :disabled="!editModel"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item size="mini" :label="'子表描述、中文名稱'" prop="detailComment">
                ...
                <el-col :span="12">
                  <el-form-item size="mini" :label="'代碼相對文件夾路徑'" prop="folder">
                    <el-input v-model="firstTemp.folder" :disabled="!editModel"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item size="mini" :label="'其它生成選項'" prop="options">
        ...
        <el-col :span="!showTitleDialog ? 24 : 12" class="fh detail-card">
          <el-card shadow="nerver" class="demo-card fh" id="secondCard">
            <div slot="header">
              <i
                class="show-title-button"
                :class="showTitleDialog ? 'el-icon-d-arrow-left' : 'el-icon-d-arrow-right'"
                :title="showTitleDialog ? '展開' : '收縮'"
                @click="showTitleDialog=!showTitleDialog"
              ></i>
              <span v-if="radio == ''">子表明細</span>
              <span v-else>{{tableName}}子表明細</span>
              ...
              <el-button
                v-if="editModel"
                type="danger"
                class="filter-item edit-button delete-button"
                size="mini"
                v-waves
                icon="el-icon-delete"
            ...
            >
              ...
              <el-table-column prop="tableName" label="表名稱" show-overflow-tooltip></el-table-column>
              <el-table-column prop="columnName" label="列名稱" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column prop="columnType" label="列類型" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-input
                    @keyup.enter.native="handleUpdateDetail(scope.row)"
                    v-if="editModel"
                    size="mini"
              ...
              <el-table-column prop="isKey" label="是否主鍵" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
              ...
              <el-table-column prop="isIncrement" label="是否自增" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
                    v-model="scope.row.isIncrement"
                    :active-value="true"
                    :disabled="!editModel"
                    :inactive-value="false"
                  ></el-switch>
              ...
              <el-table-column prop="isRequired" label="是否必填" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
              ...
              <el-table-column prop="isInsert" label="是否為插入字段" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
              ...
              <el-table-column prop="isEdit" label="是否編輯字段" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
              ...
              <el-table-column prop="isList" label="是否列表字段" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
              ...
              <el-table-column prop="isQuery" label="是否查詢字段" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-switch
                    @change="handleUpdateDetail(scope.row)"
                    v-if="editModel"
              ...
              <el-table-column prop="createUserName" label="創建人姓名" show-overflow-tooltip></el-table-column>
            ...
            <pagination
              ...
              :total="secondTotal"
              :page.sync="secondQuery.page"
              :limit.sync="secondQuery.limit"
              @pagination="handleSecondPage"
            />
          </el-card>
        </el-col>
      </el-row>
    ...
    createData() {
      ...
      this.$refs["dataForm"].validate((valid) => {
        if (valid) {
          ...
          builderTables.add(tempData).then(() => {
