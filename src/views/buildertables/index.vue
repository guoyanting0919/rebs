      ...
      <div class="flex-item">
        <el-card shadow="nerver" class="demo-card fh">
          <el-table ref="multipleTable" id="firstCard" :key='tableKey' :data="mainList" v-loading="listLoading" border
            ...
            <el-table-column prop="tableName" label="表英文全称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="comment" label="表描述、中文名称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="detailTableName" label="子表英文全称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="detailComment" label="子表描述、中文名称" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="folder" label="代码相对文件夹路径" show-overflow-tooltip></el-table-column>
            <el-table-column prop="options" label="其它生成选项" show-overflow-tooltip></el-table-column>
          ...
          <el-card shadow="nerver" class="demo-card fh">
            ...
            <el-form :rules="mainRules" ref="dataForm" :model="firstTemp" label-position="right" label-width="140px" style="height:calc(100% - 34px);overflow: auto;">
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item size="mini" :label="'表英文全称'" prop="tableName">
                    <el-input v-model="firstTemp.tableName" :disabled="!editModel"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item size="mini" :label="'表描述、中文名称'" prop="comment">
                ...
                <el-col :span="12">
                  <el-form-item size="mini" :label="'子表英文全称'" prop="detailTableName">
                    <el-input v-model="firstTemp.detailTableName" :disabled="!editModel"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item size="mini" :label="'子表描述、中文名称'" prop="detailComment">
                ...
                <el-col :span="12">
                  <el-form-item size="mini" :label="'代码相对文件夹路径'" prop="folder">
                    <el-input v-model="firstTemp.folder" :disabled="!editModel"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item size="mini" :label="'其它生成选项'" prop="options">
        ...
        <el-col :span="!showTitleDialog ? 24 : 12" class="fh detail-card">
          <el-card shadow="nerver" class="demo-card fh" id="secondCard">
            <div slot="header">
              ...
              <el-button v-if="editModel" type="danger" class="filter-item edit-button delete-button" size="mini" v-waves icon="el-icon-delete" @click="onBtnClicked('btnDelDetail')">删除</el-button>
            </div>
            <el-table ref="secondTable" border :data="secondList" tooltip-effect="dark" height="calc(100% - 44px)"
              ...
              <el-table-column prop="isKey" label="是否主键" show-overflow-tooltip>
                <template slot-scope="scope">
              ...
              <el-table-column prop="isInsert" label="是否为插入字段" show-overflow-tooltip>
                <template slot-scope="scope">
              ...
              <el-table-column prop="isEdit" label="是否编辑字段" show-overflow-tooltip>
                <template slot-scope="scope">
              ...
              <el-table-column prop="isQuery" label="是否查询字段" show-overflow-tooltip>
                <template slot-scope="scope">
              ...
              <el-table-column prop="queryType" label="查询方式" width="120" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-select @change="handleUpdateDetail(scope.row)" v-if="editModel" class="filter-item" style="width:100%;" size="mini" v-model="scope.row.queryType" placeholder="Please select">
                    <el-option v-for="item in queryTypes" :key="item.value" :label="item.key"
                      :value="item.value">
                    </el-option>
                  </el-select>
              ...
              <el-table-column prop="htmlType" label="显示类型" width="120" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-select @change="handleUpdateDetail(scope.row)" v-if="editModel" class="filter-item" style="width:100%;" size="mini" v-model="scope.row.htmlType" placeholder="Please select">
                    <el-option v-for="item in typeLists" :key="item.value" :label="item.key"
                      :value="item.value">
                    </el-option>
                  </el-select>
              ...
              <el-table-column prop="createUserName" label="创建人姓名" show-overflow-tooltip></el-table-column>
